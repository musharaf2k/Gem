...
const elements = {
    ...
    gemstoneMoral: document.getElementById('gemstone-modal'),
...
function toggleCountryDropdown(e) {
    e.stopPropagation();
    const dropdown = elements.countryDropdown;
    const selector = elements.countrySelector;
    ...
    featuredProducts.forEach(product => {
        ...
        slide.innerHTML = `
            <div class="slide-image">
                <img src="${product.image}" alt="${product.name}" onclick="openGemstoneModal(featuredProducts[${product.id - 1}])">
            </div>
            <div class="slide-content">
                ...
                <div class="slide-footer">
                    ...
                    <button class="btn-primary" onclick="openGemstoneModal(featuredProducts[${product.id - 1}])">View Details</button>
                </div>
            </div>
        `;
...
function updateCartDisplay() {
    ...
    if (cartCount) {
        ...
        cartCount.classList.toggle('visible', cartItems > 0);
    }
}
...
document.addEventListener('keydown', function(e) {
    ...
    if (e.key === 'Escape') {
        ...
        if (elements.countryDropdown.classList.contains('active')) {
            elements.countryDropdown.classList.remove('active');
            elements.countrySelector.classList.remove('active');
        }
    }
